  ...
  Exemplos:
    ...
    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    Salvar sem kind, então kind é tertiary                    |  labelText:'Salvar'                                                                                                           | btn_salvar:                                        |
                                                              |                                                                                                                               |   inside body                                      |
                                                              |                                                                                                                               |   text is "Salvar"                                 |
                                                              |                                                                                                                               |   css background-color is "rgba(255, 255, 255, 1)" |
    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    Salvar com mode visible e sem kind, então kind é tertiary |    labelText:'Salvar', mode: 'visible'                                                                                        | btn_salvar:                                        |
                                                              |                                                                                                                               |   inside body                                      |
                                                              |                                                                                                                               |   text is "Salvar"                                 |
                                                              |                                                                                                                               |   css background-color is "rgba(255, 255, 255, 1)" |
    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Salvar com hintText                                       | labelText:'Salvar', hintText: 'Salvar as informações do paciente'                                                             | btn_salvar:                                        | Salvar as informações do paciente
                                                              ...
                                                              |                                                                                                                               |   css background-color is "rgba(255, 255, 255, 1)" |
    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    Salvar com kind primary e mensagem de erro                | labelText:'Salvar', kind:'primary', mode: 'Existem campos obrigatórios vazios', hintText: 'Salvar as informações do paciente' | btn_salvar:                                        | Existem campos obrigatórios vazios
                                                              |                                                                                                                               |   inside body                                      |
